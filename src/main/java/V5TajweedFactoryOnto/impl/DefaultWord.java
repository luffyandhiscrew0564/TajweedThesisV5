 ...
 * Source Class: DefaultWord <br>
 * @version generated on Thu Jul 09 05:14:13 PKT 2020 by Ramsha
 */
public class DefaultWord extends WrappedIndividualImpl implements Word {

    public DefaultWord(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends Letter> getContainLetter() {
    ...
    public void addContainLetter(Letter newContainLetter) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_CONTAINLETTER,
                                       newContainLetter);
    }

    public void removeContainLetter(Letter oldContainLetter) {
