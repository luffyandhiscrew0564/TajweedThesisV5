 ...
 * Source Class: DefaultIdghaamWithoutGhunnahLetter <br>
 * @version generated on Thu Jun 04 21:14:55 PKT 2020 by Ramsha
 */
public class DefaultIdghaamWithoutGhunnahLetter extends WrappedIndividualImpl implements IdghaamWithoutGhunnahLetter {

    public DefaultIdghaamWithoutGhunnahLetter(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends Word> getComposeWord() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_COMPOSEWORD,
                                               DefaultWord.class);
    }

    public boolean hasComposeWord() {
	   return !getComposeWord().isEmpty();
    }

    public void addComposeWord(Word newComposeWord) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_COMPOSEWORD,
                                       newComposeWord);
    }

    public void removeComposeWord(Word oldComposeWord) {
