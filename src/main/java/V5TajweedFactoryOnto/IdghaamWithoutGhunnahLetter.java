 ...
 * Source Class: IdghaamWithoutGhunnahLetter <br>
 * @version generated on Thu Jul 09 05:14:13 PKT 2020 by Ramsha
 */

public interface IdghaamWithoutGhunnahLetter extends Letter {

    /* ***************************************************
     * Property http://www.tajweedontology.org/ontologies/rules#composeWord
     */
     
    /**
     * Gets all property values for the composeWord property.<p>
     * 
     * @returns a collection of values for the composeWord property.
     */
    Collection<? extends Word> getComposeWord();

    /**
     * Checks if the class has a composeWord property value.<p>
     * 
     * @return true if there is a composeWord property value.
     */
    boolean hasComposeWord();

    /**
     * Adds a composeWord property value.<p>
     * 
     * @param newComposeWord the composeWord property value to be added
     */
    void addComposeWord(Word newComposeWord);

    /**
     * Removes a composeWord property value.<p>
     * 
     * @param oldComposeWord the composeWord property value to be removed.
     */
    void removeComposeWord(Word oldComposeWord);
